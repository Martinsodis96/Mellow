...
@Configuration
@ComponentScan(basePackages = {"com.mellow.jpa"})
@EnableJpaRepositories("com.mellow.jpa.repository")
...
public class JpaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean entityManagerFactory() {
        ...
        factory.setPackagesToScan("com.mellow.jpa.entity");
        return factory;
    }
}
