...
public class CommentActivity extends AppCompatActivity {
    ...
    private void setUpCommentListView(List<Comment> comments){
        this.commentListView = findViewById(R.id.comment_listview);
        adapter = new CommentArrayAdapter(this, comments);
        commentListView.setAdapter(adapter);
        LayoutInflater layoutInflater = getLayoutInflater();
        header = (ViewGroup) layoutInflater.inflate(R.layout.activity_flow_adapter, commentListView, false);
    ...
    private void setUpContentTextLayout(){
        this.contentText = header.findViewById(R.id.content_text);
        if(contentText != null){
